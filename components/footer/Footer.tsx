    ...
    return (
        ...
        <footer className='flex justify-center items-center'>
            <div className='mx-auto px-6 py-4 gap-x-2 text-center text-gray-600 dark:text-gray-300 lg:gap-x-5'>
                ...
                <span>
                    Created by
                    <a href='https://www.linkedin.com/in/jos%C3%A9-pablo-arancibia-linker/' className='text-sky-500 ml-2 transition duration-300 ease-in-out dark:text-sky-300 hover:text-sky-300 dark:hover:text-sky-400' rel='noreferrer' target='_blank'>
