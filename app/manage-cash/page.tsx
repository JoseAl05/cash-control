  ...
  return (
    <main>
      ...
      <DifferenceExpenseIncome
        ...
        expenses={expenses}
      />
      <div className='flex flex-col items-center py-10 mx-auto lg:flex-row lg:justify-center lg:items-baseline'>
        ...
        <div className='hidden lg:visible lg:flex lg:flex-col lg:gap-y-2'>
          <DateFilter />
        </div>
